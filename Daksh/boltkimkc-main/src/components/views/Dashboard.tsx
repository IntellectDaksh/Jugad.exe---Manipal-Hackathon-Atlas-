...
import { DollarSign, TrendingDown, AlertTriangle, CheckCircle2, Activity, AlertOctagon, ArrowRight, Users, Building2 } from 'lucide-react';
...
export function Dashboard({ onSelectBorrower, onViewLedger }: DashboardProps) {
  ...
  const stats = useMemo(() => {
    ...
    return { totalExposure, totalEMI, avgRSI, critical, watch, performing };
  }, [borrowers]);
